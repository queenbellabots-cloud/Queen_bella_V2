...
// ═══════════════════════════════════════════════════════
// 📁 LOAD OWNER FROM data/owner.json
// ═══════════════════════════════════════════════════════
function getOwnerNumber() {
    try {
        ...
        console.log('Could not load owner.json:', e.message);
    }
    return null;
}
...
async function handleMessages(conn, chatUpdate, isOwner) {
    try {
        ...
        if (text.startsWith(settings.prefix || '.')) {
            ...
            // Check if owner.json exists (saved during pairing)
            const savedOwner = getOwnerNumber();
